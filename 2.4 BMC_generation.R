...
for (cutoff in 40) {
  ...
  # Construct file name
  rds_file <- file.path(dir, paste0("Cluster3/ijw_FDR_0.05_pos_neg_mincell", cutoff, ".rds")
...
#Extract mean value
Mean_list <- readRDS(paste0(dir,"PDControl_avg_signed_Mean_list.rds"))
MSE_list <- readRDS(paste0(dir, "PDControl_avg_signed_MSE_list.rds"))
...
saveRDS(BMC, paste0(dir, "BMC.RDS")
